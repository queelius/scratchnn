...
Our one-head model has none of this structure to find. (An archived
character-level experiment in the repository,
\texttt{docs/series/archive/transformer-text.md}, visualizes exactly these
per-head patterns for readers who want to see specialization in the wild.)
